...
import calculator.config_loader as cl
from calculator.stock import Stock
from calculator.trade import Trade
import calculator.decorators as decorators
...
@decorators.write_to_file("swing-trade-report")
...
@decorators.write_to_file("swing-trade")
...
@decorators.write_to_file("value-investing-report")
